...
**Key Features:**
- Captures equity index volatility skew (higher IV for OTM puts vs. OTM calls)
- Smooth smile fitting with parametric structure
- Enforces no-arbitrage conditions per Gatheral & Jacquier (2013) methodology
